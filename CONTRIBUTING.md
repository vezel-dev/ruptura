...
The [issue tracker](https://github.com/vezel-dev/ruptura/issues) is where all
...
labels can be found [here](https://github.com/vezel-dev/ruptura/labels), along
...
[here](https://github.com/vezel-dev/ruptura/milestones).
...
* The version of Ruptura being used.
...
[Pull requests](https://github.com/vezel-dev/ruptura/pulls) are a great way to
...
git clone git@github.com:<your-name>/ruptura.git
cd ruptura
# Set up a remote pointing to the upstream repository.
git remote add upstream git@github.com:vezel-dev/ruptura.git
```
